...
urlpatterns = [
    ...
    path('send_friends_request/<int:userID>/', views.send_friends_request, name='send_friends_request'),
    path('accept_friends_request/<int:requestID>', views.accept_friends_request, name='accept_friends_request'),
]